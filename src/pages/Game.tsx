...
export default function Game() {
  ...
  return (
    <div
      className={`relative isolate flex h-full min-h-0 flex-col overflow-hidden ${shakeScreen ? 'animate-shake' : ''}`}
    >
      ...
      <div className="safe-top relative z-40 px-3 pt-2">
        ...
        <button
          ...
          className="absolute right-3 top-[calc(0.5rem+env(safe-area-inset-top))] flex h-10 w-10 items-center justify-center rounded-full border border-white/85 bg-white/85 shadow-[0_5px_14px_rgba(93,64,55,0.14)] backdrop-blur-sm transition-transform active:translate-y-0.5 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-accent-pink/40"
        >
          {gameStatus === 'paused' ? (
      ...
      <div className="relative z-10 flex min-h-0 flex-1 items-center justify-center px-5 pb-[calc(1rem+env(safe-area-inset-bottom))]">
