...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <motion.button
        className="absolute top-[calc(env(safe-area-inset-top)+1.5rem)] right-5 z-10 w-11 h-11 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center shadow-md"
